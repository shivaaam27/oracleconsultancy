...
async function main() {
  ...
  // processes.json (pipeline) and registers.json (commitments) are no longer read.
  ...
  // Pipeline and commitments were seeded here until Applications and
  // Commitments were removed (26 Sept 2026).
