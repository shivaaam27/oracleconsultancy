...
const NEW_TASKS: NewTask[] = [
  ...
  { prefix: "OC", companyId: 4, title: "Oracle / HR system development (May)",
    desc: "Researched and built the in-house Oracle/HR admin system: web-development research, Claude AI tooling understanding, and iterative HR system development.",
    update: "HR/Oracle system development progressed through May." },
