...
import { getAllTasks, computeCompanyKpis, type TaskRow, type CompanyKpi } from "../tasks/queries";
import { getCompanyLogoMap } from "../companies/company-brand";
import { isOpen } from "../tasks/derive";
import { listDocuments, type DocumentRow } from "../documents/documents";
import { leaveMetrics } from "../people/leave";
import { deriveDocStatus, expiryLabel } from "../documents/documents-shared";
import { normalizePersonType, PERSON_TYPE_LABELS, type PersonType } from "../people/person-types";
import { listObligations, outstandingDeadlines } from "../operations/recurring";
import { getAppSettings } from "../settings";
import { listCalendarEvents } from "../calendar/calendar";
import { hasElapsed } from "../calendar/event-time-shared";
import { listBriefNotes, type BriefNote } from "./brief-notes";
import { type CcFlag } from "../operations/command-centre";
import { sb } from "@/db/supabase";
import { BRAND_NAME } from "../companies/brand";
import { appBaseUrl } from "@/lib/app-url";
import type { EmailDoc, EmailTone } from "@/lib/email/layout";
import type { BriefPersonRole } from "@/lib/reports/brief-links";
