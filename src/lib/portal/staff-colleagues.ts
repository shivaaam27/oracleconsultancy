...
import { colleagueCompanyScope, commandCentrePersonIds } from "@/lib/portal/portal-auth";
import { getPersonCompaniesMap, type PersonRow } from "@/lib/people/people-queries";
