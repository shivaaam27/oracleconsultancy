...
import { normalizePersonType, PERSON_TYPES, type PersonType } from "@/lib/people/person-types";
import { type Journey, type JourneyKind, type JourneyStep } from "@/lib/people/onboarding-shared";
...
/*                                                                     */
/* Client-safe types + labels live in lib/people/onboarding-shared.ts.        */
/* ------------------------------------------------------------------ */
export type { Journey, JourneyKind, JourneyStep } from "@/lib/people/onboarding-shared";
