...
//
// Everything derives from src/lib/search/entity-registry.ts (the single source of
...
import { indexEmbedding, removeEmbedding } from "@/lib/search/embeddings";
import {
  getEntityDef,
  ...
  type EntityType,
  type EntityRow,
} from "@/lib/search/entity-registry";
