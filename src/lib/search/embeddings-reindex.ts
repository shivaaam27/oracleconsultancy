...
// single source of truth in src/lib/search/entity-registry.ts (ENTITY_DEFS +
...
import { indexEmbedding, type SourceType, type Lifecycle } from "@/lib/search/embeddings";
import { ENTITY_DEFS, getGovernanceRows, isGovernance, type EntityRow } from "@/lib/search/entity-registry";
