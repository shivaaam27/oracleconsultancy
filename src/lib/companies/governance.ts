...
import { GOV_BASE } from "@/lib/search/entity-registry";
import {
  riskScore,
  ...
  type Signatory,
  type Resolution,
} from "@/lib/companies/governance-shared";
...
export type { CompanyGovernance, Ubo, KeyPerson, Risk, Decision } from "@/lib/companies/governance-shared";
