...
import { buildEventEmail } from "@/lib/calendar/event-email";
import { eventAttachmentLinks } from "@/lib/calendar/event-documents";
import { listCalendarEvents, type CalendarEvent } from "@/lib/calendar/calendar";
import {
  buildReminderBody,
  dueReminders,
  leadPhrase,
  ...
  MAX_CATCHUP_MS,
  MAX_LOOKAHEAD_DAYS,
} from "@/lib/calendar/event-reminders-core";
...
/** Minimal row→event mapping for the recurring query (mirrors lib/calendar/calendar). */
