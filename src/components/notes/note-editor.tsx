...
import { NoteTaskItem } from "@/components/notes/note-task-item";
import { Table, TableRow, TableCell, TableHeader } from "@tiptap/extension-table";
import { SlashCommands } from "@/components/notes/note-slash-menu";
import { Mention, MentionPickers } from "@/components/notes/note-mention";
import { ActiveLine } from "@/components/notes/note-active-line";
import { NoteImage } from "@/components/notes/note-image";
import { Callout, CALLOUT_TONES, CALLOUT_TONE_LABELS } from "@/components/notes/note-callout";
import { NoteAiPanel } from "@/components/notes/note-ai-panel";
import { attachFileAtCaret, filesFrom } from "@/lib/notes/note-upload";
...
import { NoteTouchDrag } from "@/components/notes/note-touch-drag";
import { NoteCaret } from "@/components/notes/note-caret";
...
import { extractMentions } from "@/lib/notes/note-links-shared";
import { findUnlinked, findWholeWord, type LinkCandidate } from "@/lib/notes/note-unlinked-shared";
...
export function NoteEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      ...
      /* Paste a screenshot, drop a file. Both go through the SAME upload path as
         the toolbar button (lib/notes/note-upload.ts), so there is one place where a
  ...
  /* THE SHEET ENDS WHERE THE SCREEN ENDS.
     ...
     The measuring now lives in `lib/hooks/use-fill-viewport.ts`, shared with every list
  ...
  return (
    ...
    >
      ...
      {/* Names you wrote without linking. A quiet strip at the FOOT of the sheet,
          ...
          It offers; it never links by itself — see lib/notes/note-unlinked-shared.ts. */}
