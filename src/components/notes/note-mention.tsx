...
import { createMenuPositioner } from "@/lib/nav/suggestion-position";
import { linkHref, mentionText, type LinkType, type MentionRef } from "@/lib/notes/note-links-shared";
...
function mentionSuggestion(opts: {
  ...
  return {
    ...
    render: () => {
      ...
      // Shared with the `/` menu — see lib/nav/suggestion-position.ts. It is what keeps
