...
import { JourneyChecklist } from "@/components/people/journey-checklist";
import { StudioPersonEquipment } from "./person-equipment";
import { FactsPanel } from "@/components/companies/facts-panel";
import { PersonProbation } from "@/components/people/person-probation";
import { PersonPackPanel } from "@/components/people/person-pack-builder";
import { DeletePersonDialog } from "@/components/people/delete-person-dialog";
import { LinkedNotesTab } from "@/components/notes/linked-notes";
import { PersonForm, type Defaults as PersonFormDefaults } from "@/components/people/person-form";
import { useToast } from "@/components/shell/toast";
import { withReturn } from "@/lib/nav/return-to";
import { PERSON_TYPE_LABELS, type PersonType } from "@/lib/people/person-types";
import { ROLE_LABEL, SCOPE_WORDS, asPortalRole, type PortalRoleKey, type ScopeLevel } from "@/lib/portal/portal-permissions";
