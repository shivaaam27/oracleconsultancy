  ...
  return createPortal(
    <div className="fixed inset-0 z-[55]" role="dialog" aria-modal="true">
      ...
      <div
        ...
        className={cn(
          "studio st-sheet st-sheet-dots st-pop absolute bottom-[calc(var(--foot-h)+var(--foot-safe)+8px)] left-1/2 flex max-h-[calc(100dvh-100px)] -translate-x-1/2 flex-col overflow-hidden rounded-3xl",
