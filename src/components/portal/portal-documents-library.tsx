...
import { RecordList } from "@/components/kit/record-list";
import { buildColumns } from "@/components/kit/entity-cells";
import { ENTITY_VIEWS } from "@/lib/entity-view";
import { useUrlFilters } from "@/lib/hooks/use-url-filters";
import { DOC_CATEGORIES, deriveDocStatus, docStatusColor, type DocStatus } from "@/lib/documents/documents-shared";
import type { PortalDocRow } from "@/lib/portal/portal-documents";
...
export function PortalDocumentsLibrary({ docs }: { docs: PortalDocRow[] }) {
   ...
   * list follows (see lib/hooks/use-url-filters.ts). It also means a rail entry is a
