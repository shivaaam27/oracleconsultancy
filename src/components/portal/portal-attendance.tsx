...
import { ATTENDANCE_SELF_STATUSES, ATTENDANCE_ABBR, ATTENDANCE_CELL, type AttendanceStatus } from "@/lib/people/leave-shared";
import type { PortalAttendanceDay } from "@/lib/people/attendance";
