...
import { Copy, Check, Trash2, KeyRound, Plus } from "lucide-react";
import { Button, Input } from "@/components/ui";
import type { McpKeyRow } from "@/app/settings/mcp-actions";
...
export function McpKeyManager({ initial, create, revoke }: Props) {
