...
import { IconButton, EmptyState, SectionCard, DefGrid, GroupLabel, CollapsibleSection } from "../kit/drawer-kit";
import { CompanyDrawerLink } from "../companies/company-drawer-link";
import { StaffIdChip } from "./staff-id-chip";
import { TaskDrawerLink } from "../tasks/task-drawer-link";
...
import type { PortalRoleKey, ScopeLevel } from "@/lib/portal/portal-permissions";
...
import { personTypeLabel, type PersonType } from "@/lib/people/person-types";
import { PERSON_ACTION_LABEL, personActor, type PersonEvent } from "@/lib/people/person-audit-shared";
import { PersonProbation } from "./person-probation";
import { FactsPanel } from "../companies/facts-panel";
import type { PersonLeaveBalance, LeaveRequestRow } from "@/lib/people/leave-shared";
import type { PersonAttendanceSummary } from "@/lib/people/leave";

/* -------------------------------------------------------------------------
 * API payload types — mirror lib/people/people-queries.ts PersonDetail
 * ---------------------------------------------------------------------- */
type DrawerPerson = {
  id: number;
  name: string;
 ...
 *  and creator credit are kept as separate numbers — see src/lib/tasks/kpi.ts. */
function KpiCard({
  months,
  onOpenTasks,
}: {
