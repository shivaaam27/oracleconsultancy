...
import { setDepartmentHead } from "@/lib/people/org-actions";
import {
...
import { PERSON_TYPE_LABELS } from "@/lib/people/person-types";
import { countNodes, type CompanyTree, type OrgNode } from "@/lib/people/org-chart";
import type { OrgPersonExtras } from "@/lib/people/org-extras";
import { OrgWeb, type WebPerson } from "@/components/people/org-web";
import type { FlowPerson } from "@/lib/people/org-flow";
import type { OrgFlowCompany } from "@/components/people/org-flow";
import { OrgDirectorPicker, type PickPerson } from "@/components/people/org-director-picker";
...
const OrgFlow = dynamic(() => import("@/components/people/org-flow").then((m) => m.OrgFlow), { ssr: false });
