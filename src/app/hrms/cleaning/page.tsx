...
import { CleaningToday } from "@/components/hrms/cleaning-today";
    ...
    <div className="space-y-4">
      <div className="flex items-end justify-between gap-3 flex-wrap">
        <div className="min-w-0">
          <HrmsCrumbs />
          <h1 className="text-lg font-semibold tracking-tight">Cleaning</h1>
          <div className="text-xs text-fg-subtle">The daily office cleaning log — overview &amp; control. The receptionist logs the daily cleaning from her portal; this view reflects her ticks and lets you step in when needed.</div>
        </div>
      </div>

      <CleaningToday dateIso={dateIso} today={today} floor={floor} day={day} areas={areas} checks={checks} people={people} />
    </div>
  );
}
