...
export default function NoteNotFound() {
  return (
    <div className="mx-auto flex w-full max-w-[58rem] flex-col gap-3">
      <Link
        href="/notes"
        className="inline-flex h-7 w-fit items-center gap-1.5 rounded-md px-2 text-xs font-medium text-fg-muted transition-colors hover:bg-bg-muted hover:text-fg"
      >
      ...
      <div className="flex flex-col items-center gap-2 rounded-lg border border-border bg-bg-elev px-6 py-14 text-center shadow-sm">
        ...
        <p className="max-w-[26rem] text-sm text-fg-muted">
          It was probably deleted, or this is an old link. Nothing else has changed — your other
          notes are exactly where you left them.
        </p>
        <Link
          href="/notes"
          className="mt-2 inline-flex h-8 items-center gap-1.5 rounded-md bg-accent px-3 text-sm font-medium text-accent-fg transition-opacity hover:opacity-90"
        >
          Back to your notes
        </Link>
      </div>
