...
import { getNote, listFolders } from "@/lib/notes/notes";
import { backlinks, linkCandidates, outgoingLinks } from "@/lib/notes/note-links";
import { NoteEditorMount } from "@/components/notes/note-editor-mount";
import { NoteLinksPanel } from "@/components/notes/note-links-panel";
import { NoteTodosPanel } from "@/components/notes/note-todos-panel";
import { NoteVersionsPanel } from "@/components/notes/note-versions-panel";
import { noteTodos } from "@/lib/notes/note-todos";
import { listTemplates, noteRevisions } from "@/lib/notes/note-versions";
import { NoteRecordBar } from "@/components/notes/note-record-bar";
import { NoteExtras } from "@/components/notes/note-extras";
