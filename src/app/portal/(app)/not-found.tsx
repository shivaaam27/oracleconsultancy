...
/* Portal-scoped 404 — keeps the staff inside the portal (and away from the
 * admin-styled root 404) when a task code or page doesn't exist. */
    ...
    <div className="flex min-h-[55vh] flex-col items-center justify-center gap-4 px-4 text-center">
      ...
      <div className="max-w-sm">
        ...
        <p className="mt-1.5 text-sm text-fg-muted">
          This page or task isn&apos;t available to you, or it may have moved.
        </p>
      </div>
      <Link
        href="/portal"
