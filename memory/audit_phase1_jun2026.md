...
**Remaining backlog (all deferred items, lowest→highest effort):** 1.16-admin-pill · 4.20 · 4.13 · 7.5-move-file · 4.19-extras · 4.7 · 7.3-ai-cancel · 4.14 · 4.18 · 6.7-lazy-screens · 2.5 · 2.3-headers · 6.6-virtualise · 3.7-table-row · 6.5b-revalidate · 7.1-file-splits · 5.1-sick-cost-feature · 4.21-decision. None are data-loss or security; all are polish, a UX decision, or larger refactors/new features.
