...
- **Appendix B** — the forward roadmap as it stood in Jul 2026.
...
## Status (Sept 2026)
The playbook describes Oracle as it was in Jul 2026. Much of Part II (the self-learning
document brain, dedup, renewals, OCR intake) has since been REMOVED from Oracle, and the
AI now runs on Gemini with Groq only for voice. The generalised recipes still stand; do
not read the book as a description of the current system.
